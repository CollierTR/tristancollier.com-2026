...
# How Astro Improved My SEO by 30%
...
After a while I started entertaining the thought of starting a blog. I realized that the time to take my site's SEO seriously had come, and I was dreading the thought of converting it to Next.js. Not that Next is bad, it just wasn't for me. From past projects working with Next it always felt over engineered.
...
I rebuilt my site over a few evenings. The transition was actually pretty easy. I then compared the vanilla React site's Lighthouse SEO score against my improved Astro site. The difference was astounding! Here are the ratings:  
...
**Upon receiving the JavaScript the client runs it an by doing so generates the UI**
